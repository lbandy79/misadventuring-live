/**
 * BystanderStatPage — /keeper/bystanders/:id
 */
...
export default function BystanderStatPage() {
    ...
    <>
      <div className="stat-screen-actions no-print">
        ...
        <div className="stat-screen-right">
          ...
          <Link to={`/keeper/bystanders/${threat.id}/edit`} className="btn-secondary">Edit</Link>
      ...
      <article className="stat-block monster-stat-block">
        <header className="stat-block-header">
          <div className="stat-block-title-row">
            ...
            <span className="stat-block-category typewriter-label">Bystander</span>
          </div>
        ...
        {threat.weapon && (
          <section className="stat-section">
            <h2 className="stat-section-label">Weapon</h2>
            <p className="stat-description">
              {threat.weapon.name} ({threat.weapon.harm}-harm{threat.weapon.tags.length ? ' ' + threat.weapon.tags.join(', ') : ''})
            </p>
          </section>
        )}
